...
export class MathOps {
    ...
    cos(x: number | Value): number | Value {
        ...
        const handle = this.session.wasm.cos_fast(x.handle);
        return new Vector(this.session, handle);
    }
    ...
    tan(x: number | Value): number | Value {
        ...
        const handle = this.session.wasm.tan_fast(x.handle);
        return new Vector(this.session, handle);
    }
    ...
    exp(x: number | Value): number | Value {
        ...
        const handle = this.session.wasm.exp_fast(x.handle);
        return new Vector(this.session, handle);
    }
    ...
    ln(x: number | Value): number | Value {
        ...
        const handle = this.session.wasm.ln_fast(x.handle);
        return new Vector(this.session, handle);
    }
    ...
    sqrt(x: number | Value): number | Value {
        ...
        const handle = this.session.wasm.sqrt_fast(x.handle);
        return new Vector(this.session, handle);
    }
    ...
    abs(x: number | Value): number | Value {
        ...
        const handle = this.session.wasm.abs_fast(x.handle);
        return new Vector(this.session, handle);
    }
