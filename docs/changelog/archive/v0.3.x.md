# Changelog - Version 0.3.x (Archived)

This file contains all changes for the 0.3.x release series.
...
### Performance
- Complex arithmetic: <10us per operation
- Vector operations: <5us for basic ops
- Matrix multiplication (2x2): <20us
