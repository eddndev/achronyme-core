/**
 * Simple demo runner for testing Achronyme SDK
 */
...
// Import the demo
const demoPath = join(__dirname, 'demos', 'numerical-calculus-demo.ts');

console.log('Loading demo from:', demoPath);
console.log('Note: This requires the TypeScript to be compiled first');
console.log('Run: npm run build\n');

// For now, we'll use the eval method instead
